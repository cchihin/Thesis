...
\end{equation}
Substituting the decomposition into the Navier-Stokes equations and linearising (neglecting nonlinear terms), we get
...
Using $(v, \eta)$, we introduce a modal ansatz:
...
\begin{figure}[h]
    ...
    \label{fig:toy_model}
\end{figure}
To demonstrate an example of transient growth, we consider a two-dimensional toy model governing the time-evolution of $\mathbf{q} = (v, \eta)^T$ as 
\begin{equation}
