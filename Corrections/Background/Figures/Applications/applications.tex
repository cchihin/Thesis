\begin{figure}[ht]
    ...
    \caption{Thermoconvective shear flows driven by shear and bouyancy forces across length scales, $L \in [10^{-2}m, 10{^3}m]$. Examples include (a) chip cooling, (b) chemical vapour deposition and (c) the formation of cloud streets.}
\end{figure}
