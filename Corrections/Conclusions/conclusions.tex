...
\begin{enumerate}
    ...
    \item The extension of the \textit{thermally-assisted sustaining process} to other buoyancy and shear driven systems such as the Rayleigh-B\'{e}nard Couette (RBC) flow, for which the absence of a mean flow may facilitate experimental verification.
    ...
    \item Performing a Floquet analysis to study the behaviour of superharmonic, subharmonic, and wavenumber-detuned perturbations.
\end{enumerate}
