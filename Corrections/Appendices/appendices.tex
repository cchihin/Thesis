\appendix
\chapter{Transitional Rayleigh-B\'{e}nard Poiseuille flows}\label{chap:appendices}
...
\chapter{State-space structure of spiral defect chaos}
...
\begin{figure}
    ...
    \caption{Temperature snapshots, $\theta(x,z)|_{y=d/2}$, of 14 stable ideal straight rolls (ISRs) confined within a minimal domain, $\Gamma = 6.28$. Plots (a-n) are ordered in increasing wavenumbers, $q \in (2/d, 3.35/d)$. We note that these states are distinct and are not equivalent to each other under any combinations of spatial rotation, translation or reflection.}
    \label{fig:ISRs}
\end{figure}
