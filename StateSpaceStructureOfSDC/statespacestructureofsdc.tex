...
\subsection {Scope of this study}\label{sec:rbc_objs}
...
The Rayleigh number and the Prandtl numbers are defined as in \S\ref{sec:rbc_intro}: $Ra = \alpha g d^3 \Delta T / \nu \kappa$, Prandtl number $Pr = \nu / \kappa$. Throughout this study, $Pr=1$ is set. 
