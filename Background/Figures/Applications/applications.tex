\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=1.3]
        ...
        \node [label={[align=center] $L$}] at (9.8,-2.2) {};
        \draw [->, thick, black] (-1,-1.5) -- (10,-1.5);
        % \draw [->, thick, white] (0,-1.8) -- (8.1,-1.8);
    \end{tikzpicture}
    \label{fig:applications}
    \caption{Fluid flow due to shear and bouuyancy forces across length scales, $L \in [1cm, 1km]$, such as (a) chip cooling, (b) chemical vapour deposition and (c) formation of cloud streets.}
\end{figure}
